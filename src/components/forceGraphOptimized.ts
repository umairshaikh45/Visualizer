...
// Helper function to determine file importance based on type and connections
...
// Helper function to group files by directory structure
  ...
  const simulation = d3.forceSimulation(processedNodes as any)
    ...
    .force("collision", d3.forceCollide()
      .radius(d => {
        ...
        return Math.max(8, 6 + importance * 1.2);
      })
      .strength(0.7)
    )
    .alphaDecay(0.08) 
